...
Pulitzer.Prize.Change <- mutate(pulitzer, difference.2004.2014.to.1990.2003 = 
...
m.p.2014.publication <- filter(Pulitzer.Prize.Change, Pulitzer.Prize.Winners.and.Finalists..2004.2014 == 
...
m.award.winning.decrease <- filter(Pulitzer.Prize.Change, Pulitzer.Prize.Winners.and.Finalists..2004.2014 >= 5) %>% 
